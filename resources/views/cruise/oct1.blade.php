...
<form style="    display: flex;
 ...
 <section class="primary-color no-margin pad-10 mid-space set-bg-base">
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="col-md-6 col-md-offset-3 package-listing">
            <h4 class="center no-float">MILESTONE ON THE SEA</h4>
            <!--span>&#8358; 30,000 p/head</span-->
            <span class="span-price" style="position: relative">&#8358; 30,000 <em class="subprice">
            (per person)</em></span>
            Get ready to ride the waves as we set sail on the magnificent Eugene 1 this October 1st. From exploring the exceptional views of Lagos and savouring mouth watering 3-course dishes to enjoying hip music that keeps you on your toes. 
