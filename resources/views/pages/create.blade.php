...
<div class="row">
	<div class="col-lg-6 offset-md-3">
		...
		<div class="kt-portlet">
			...
			<!--begin::Form-->
			<form class="kt-form" enctype="multipart/form-data" method="post" action="{{ route('pages.store') }}">
				@csrf
				<div class="kt-portlet__body">
					...
					<div class="kt-section kt-section--first">
						...
						<div class="form-group">
							<label>Value</label>
							<textarea class="form-control" name="value" placeholder="Enter value">{{ old('value') }}</textarea>
