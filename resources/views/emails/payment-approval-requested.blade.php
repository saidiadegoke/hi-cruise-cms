...
<body>
    <div id="app" class="text-center mt-4">
        ...
        <p>Thank you for booking a reservation. This is to confirm that we have received your payment request. Your ticket will be sent to you as soon as we confirm your payment.</p>
    </div>
</body>
</html>
